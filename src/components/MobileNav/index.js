...
function MobileNav({ direction, handleShowNavigation, routes }) {
  ...
  const handleChangeNavHidden = ()=>{
    document.getElementsByTagName("aside")[0].style.width="15vw";
  }
  return (
    <nav
      className={
          ...
          >
            {!item.children ? (
              ...
              >
                ...
                <span className={`navName maL12 `}>{item.text}</span>
                </div>
              </Link>
            ) : (
              <div className="flexB">
