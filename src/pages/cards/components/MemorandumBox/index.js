...
export default function MemorandumBox({}) {
  useEffect(() => {}, []);
  return (
    <div className={styles.memorandumBox}>
        ...
        <li className={styles.list_years}>
          ...
          <ul className={`${styles.dayList} maB6`}>
            ...
            <li className="pa12 bg3 borderR12">
              ...
              <p className="font16 textColorGray">25号公司聚餐，出去野营...</p>
            </li>
            <li className="pa12 bg3 borderR12">
              <div className="flexB">
              ...
              <p className="font16 textColorGray">
